    ...
    return (
        <section className="py-32">
            <div className="px-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 relative">
                <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl">{servicesData.title}</h1>
                    ...
                    <div className="grid w-full grid-cols-1 gap-8 lg:w-1/2 xl:gap-16 md:grid-cols-2">
                        {servicesData.components.map((component, index) => (
                            <div key={index} className="space-y-3">
                                <span className="inline-block p-3 text-white rounded-xl bg-primary shadow-primary shadow-2xl">{component.icon}</span>

                                <h1 className="text-xl font-semibold text-gray-700 capitalize">{component.title}</h1>
