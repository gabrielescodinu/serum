            ...
            <div className="max-w-[85rem] px-4 py-32 sm:px-6 lg:px-8 mx-auto relative">
                <div className="max-w-2xl lg:max-w-5xl mx-auto">
                    <div className="text-center">
                        <h1 className="text-3xl font-bold text-gray-100 sm:text-4xl">Contact us</h1>
                        <p className="mt-1 text-gray-600 dark:text-gray-300">We'd love to talk about how we can help you.</p>
                    </div>
                    <div className="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
                        {/* Card */}
                        <div className="flex flex-col bg-white/[.075] rounded-xl p-4 sm:p-6 lg:p-8">
                            ...
                            <form>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="py-3 px-4 block w-full rounded-md text-sm border-none focus:outline-none focus:border-primary focus:ring-primary dark:bg-white/[.075] dark:text-gray-400"
                                ...
                                <div className="mt-4 grid">
                                    <button
                                        type="submit"
                                        className="inline-flex justify-center items-center gap-x-3 text-center bg-primary hover:bg-gray-700 text-sm lg:text-base text-white font-medium rounded-md focus:outline-none transition py-3 px-4"
                                    >
                                        Send inquiry
                                    </button>
                                </div>
                        ...
                        <div className="divide-y divide-gray-500">
                            {cards.map((cards) => (
                                <div key={cards.id} className="flex gap-x-7 py-6">
                                    {cards.icon}
                                    <div>
                                        <h3 className="font-semibold text-gray-800 dark:text-gray-200">{cards.title}</h3>
                                        <p className="mt-1 text-sm text-gray-500">{cards.description}</p>
                                        <a
                                            className="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-300 hover:text-gray-500"
                                            href={cards.linkUrl}
                                        >
                                            {cards.linkText}
                                            <svg
                    ...
                    <div className="absolute inset-0 max-w-lg my-auto ml-auto h-72 blur-[118px]" style={{ background: "linear-gradient(#14b8a642, #14b8a61a)" }}></div>
                </div>
            </div>
        </section>
    );
